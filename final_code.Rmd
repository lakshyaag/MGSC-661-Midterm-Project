...
```{r}
data <- read.csv("./data/IMDB_data_Fall_2023.csv")
```
...
ggsave(filename = "./deliverables/plots/imdb_score.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/movie_budget.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/release_year.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/release_month.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/number_faces.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/duration.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/movie_budget_imdb_score.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/duration_imdb_score.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/genre_imdb_score.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/release_month_imdb_score.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/actor1_imdb_score.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/distributor_imdb_score.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/corr_plot.png", device = "png")
...
ggsave(filename = "./deliverables/plots/individual_regressions.png", device = "png")
```
...
ggsave(filename = "./deliverables/plots/multiple_linear_regression.png", device = "png")
```
...
stargazer(performance, header = FALSE, digits = 2, type = "latex", out = "./deliverables/tables/model_performance.html", summary = FALSE, title = "Model performance")
```

# Using the models
```{r}
test_data <- read.csv("./data/test_data_IMDB_Fall_2023.csv")
test_data
```
## Cleaning test data
```{r}
...
```
```{r}
stargazer(predictions, header = FALSE, digits = 2, type = "latex", out = "./deliverables/tables/predictions.html", summary = FALSE, title = "Model predictions")
```
...
coeftest(poly_k_fold, vcov = vcovHC(poly_k_fold, type = "HC1")) %>%
  stargazer(
    ...
    digits = 2,
    type = "latex",
    out = "./deliverables/tables/polynomial_regression_summary.html",
